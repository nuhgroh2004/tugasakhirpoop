...
class CharacterButton extends JButton {
    ...
    public CharacterButton(String startGame) {
        //Init color
        super(startGame);
        colorOver = new Color(250, 212, 74);
        colorClick = new Color(89, 222, 71);
        borderColor = new Color(253, 198, 0);
